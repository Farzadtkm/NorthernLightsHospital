...
namespace NLHospital
{
    ...
    public class frmNLHospital : NLHBase
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var oFind = oUsers.FindData(user, password);

                sMsg = "Welcome " + oFind.Tables["Login"].Rows[0]["UserName"].ToString();

                switch (user)
                {
                    case "Admissions":
                        var admitForm = new FrmAdmissions
                        {
                            Visible = true
                        };
                    ...
                    case "Doctor":
                        ...
                        menuForm.oCurrent.UserName = user;
