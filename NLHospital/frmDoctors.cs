...
namespace NLHospital
{
    ...
    public class frmDoctors : NLHBase
    {
        ...
        {
            var doctorId = txtDoctorID.Text;
            
            var lastName = txtLastName.Text;
            
            var firstName = txtFirstName.Text;
            
            var specialty = cboSpecialty.Text;
            ...
            try
            {
                message = doctors.AddData(doctorId, lastName, firstName, specialty);
            }
            catch
            {
            ...
            {
                MessageBox.Show(message, "Add Record", MessageBoxButtons.OK);
            }
        }
        ...
        private void btnFind_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                cboSpecialty.SelectedIndex = BindingContext[o_Find, "Doctors"].Position;
